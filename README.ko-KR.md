...
> **EXE 다운로드:** [Releases](https://github.com/bvzrays/forza-painter-fh6/releases)에서 `forza-painter-fh6-v1.6.5.exe`를 내려받아 바로 실행하세요.
...
1. [Releases](https://github.com/bvzrays/forza-painter-fh6/releases)에서 `forza-painter-fh6-v1.6.5.exe`를 다운로드합니다.
