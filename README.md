...
<p align="center">
  <code>v1.6.5</code> · <code>Windows</code> · <code>Forza Horizon 6</code> · <code>GPU/OpenCL</code> · <code>One-file EXE</code>
</p>
...
> **Download the EXE:** get `forza-painter-fh6-v1.6.5.exe` from [Releases](https://github.com/bvzrays/forza-painter-fh6/releases) and run it directly.
...
1. Download `forza-painter-fh6-v1.6.5.exe` from [Releases](https://github.com/bvzrays/forza-painter-fh6/releases).
